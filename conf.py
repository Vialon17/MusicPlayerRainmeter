import configparser, random, re

def config(section, name) -> str:
    '''
    import the conf.ini file and get value
    '''
...
def url_get(url):
    localhost = config('ProxyServer', 'port')
    return 'http://localhost:{}'.format(localhost) + url

def headers_get(url, use='pc') -> dict:
    '''
    copy this function from URL:https://www.cnblogs.com/huangyuechujiu/p/12893982.html
    copy data:2022.1.13
    '''
    pc_agent = [
...
def main():
    print(headers_get('https://www.cnblogs.com/huangyuechujiu/'))
